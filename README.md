...
Since this is the project source, and **not** an executable, you'll have to compile this using Cargo after downloading. Cargo.toml has some optimisations that need to be cleared to ensure that the executable is generated properly, like dynamic linking needs to be removed.
